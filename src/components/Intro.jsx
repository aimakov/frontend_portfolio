...
const Intro = () => {
  ...
  return (
    <div className="relative bg-gradient-to-t from-indigo-200 flex flex-col justify-center items-center">
      ...
      <div className="w-full min-h-screen flex flex-col lg:flex-row lg:justify-center lg:items-center lg:pt-[72px] justify-start gap-20 items-start">
        {/* <div className="bg-[url('/public/assets/images/almaty.jpeg')] w-11/12 h-[300px] bg-cover bg-center rounded-3xl mx-auto"></div> */}
        <div className="lg:flex-1">
          <img
            className=" full lg:max-w-xl rounded-b-2xl flex-grow"
            src="/assets/images/almaty.jpeg"
            alt=""
          />
        </div>
        ...
        <div className="w-11/12 lg:w-2/4 shrink mx-auto flex flex-col justify-evenly items-start lg:items-center gap-6">
          <h2 className="text-[2.3rem] lg:text-[5rem] font-semibold flex flex-col lg:flex-row">
            <span>Hi,&nbsp;</span>
            <span>
