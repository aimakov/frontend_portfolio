        ...
        <div className="relative  flex flex-col justify-center items-center bg-[url('/public/assets/images/bg.jpeg')]">
            <nav className="w-full fixed top-0 bg-white bg-opacity-50 rounded-b-xl backdrop-blur-md ">
                <div className=" container mx-auto py-5 px-10 flex justify-between items-center ">
                    ...
                    <div className=" space-y-1 md:hidden cursor-pointer transition-all duration-1000 z-10" onClick={handleBurderClicked}>
            ...
            <div className="w-full min-h-screen flex flex-col justify-center gap-20 items-start">
                ...
                <div className="w-11/12 lg:w-2/4 shrink mx-auto flex flex-col justify-evenly items-start lg:items-center gap-6">
                    <div className="w-48 h-48 overflow-hidden rounded-full border-4">
                        <img src="/assets/images/pink.jpeg" className="scale-[200%] translate-x-[40px] translate-y-[30px]" alt="" />
                    </div>
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <p className=" flex justify-between text-white text-[1.5rem]">React Front-End Developer </p>
                    </div>
