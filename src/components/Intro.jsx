    ...
    return (
        <Parallax bgImage="/assets/images/bg.jpeg" strength={400}>
            <div className="relative flex flex-col justify-center items-center ">
                <nav
                    className={`transition duration-200 w-full fixed top-0 bg-white ${navOpacity ? "bg-opacity-60" : "bg-opacity-0"}  rounded-b-lg  ${
                        navOpacity ? "backdrop-blur-md" : ""
                    } z-20`}
                >
                    <div className=" container mx-auto py-5 px-10 flex justify-between items-center ">
                        <div>
                            {/* <img /> */}
                            <span className={`text-2xl font-hind  ${navOpacity ? "text-gray-600" : "text-gray-200"}`}>aimakov.dev</span>
                        </div>
                        <ul className={`hidden md:flex space-x-10 uppercase text-md  ${navOpacity ? "text-gray-600" : "text-gray-200"}`}>
                            <li className={`flex items-center ${navOpacity ? "text-black" : "text-gray-100"}`}>
                                <Link
                                    to="Homepage"
                                    smooth={true}
                                    offset={-200}
                                    duration={1000}
                                    className={`${
                                        navOpacity ? "after:bg-black" : "hover:text-white after:bg-white"
                        ...
                        >
                            <li className="flex items-center">
                                <Link to="Homepage" href="#" className="hover:text-gray-200">
                                    Homepage
                                </Link>
                            </li>
                            <li className="flex items-center">
                                <Link to="AboutMe" href="#" className="hover:text-gray-200">
                                    About me
                                </Link>
                            </li>
                            <li className="flex items-center">
                                <Link to="Projects" href="#" className="hover:text-gray-200">
                                    Projects
                                </Link>
                            </li>
                        </ul>
                ...
                <div id="Homepage" className="w-full min-h-screen flex flex-col justify-center gap-20 items-start">
