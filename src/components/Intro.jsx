  ...
  return (
    <Parallax bgImage="/assets/images/bg.jpeg" strength={400}>
      <div className="relative flex flex-col justify-center items-center ">
        <nav
          className={`transition duration-200 w-full fixed top-0 bg-black ${
            navOpacity == 0 ? "bg-opacity-0" : "bg-opacity-40"
          }  rounded-b-lg  ${navOpacity !== 0 ? "backdrop-blur-md" : ""} z-20`}
        >
          <div className=" container mx-auto py-5 px-10 flex justify-between items-center ">
            <div>
              {/* <img /> */}
              <span className={`text-2xl font-hind text-gray-200`}>
                aimakov.dev
              </span>
            </div>
            <ul
              className={`hidden md:flex space-x-10 uppercase text-md text-gray-200`}
            >
            ...
            <FiMoon className={`hidden md:block text-gray-200`} />
            <div
