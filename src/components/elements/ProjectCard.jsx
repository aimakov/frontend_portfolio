...
const ProjectCard = (props) => {
    ...
    return (
        <li className="max-w-sm rounded-xl lg:h-[570px] lg:flex lg:flex-col lg:justify-between overflow-hidden shadow-lg bg-white">
            <div>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="w-full pl-6 py-2 flex justify-start gap-1">
                    {props.hashtags.map((hashtag) => (
                        <span key={hashtag} className="inline-block rounded-full py-2 text-[12px] font-semibold text-gray-700 mr-2 mb-2 ">
                            #{hashtag}
                        </span>
                    ))}
                </div>
