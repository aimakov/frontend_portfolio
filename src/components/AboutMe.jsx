    ...
    return (
        <div className="h-screen w-full flex flex-col justify-center bg-gradient-to-b from-indigo-200">
            <div className="flex flex-col justify-evenly items-center gap-10">
                ...
                <div className="w-full grid grid-rows-[40px] grid-cols-[180px_1fr] gap-y-4 items-center">
                    <h3 className="text-lg font-semibold text-right pr-2">Coding:</h3>
                    ...
                    <h3 className="text-lg font-semibold text-right pr-2">Markup & Styling:</h3>
                    <ul className="flex justify-start gap-2 pl-2">
                    ...
                    <ul className="flex justify-start gap-2 pl-2 items-center">
